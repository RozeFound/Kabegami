...
namespace vku {
    ...
    class Shader {
        ...
        bool read_cache (std::vector<std::vector<uint32_t>>& codes, fs::BinaryStream& file, XXH64_hash_t hash);
        void write_cache (std::vector<std::vector<uint32_t>>& codes, fs::BinaryStream& file, XXH64_hash_t hash);
